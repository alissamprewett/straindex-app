...
function listStrains({ q, type, rarity, effect, thc, terpene, ailment, breeder, verified, limit = 60 } = {}) {
  assertReady();
...
module.exports = {
  ...
  getUserExportData, deleteUserAccount, getAnalyticsSnapshot, listUsers,
