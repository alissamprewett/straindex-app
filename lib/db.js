...
async function giveCheckinKudos(id, userId) {
  ...
  if (alreadyGiven || userId == null) {
    // No-op: either this person already gave kudos here, or no user
    // context is available (shouldn't happen since the route requires
    // login, but stay safe rather than double-count).
