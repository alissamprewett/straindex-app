...
// All demo shop items use plain emoji icons, consistent with the rest of
// the app's icon set (no product photos here — this is illustrative demo
// content, not a real storefront).
const shopItems = [
