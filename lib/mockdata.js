...
const shopItems = [
  { id: 'sh1', name: 'StrainDex Grinder', price: '$28', icon: '/docs/shop-grinder.jpg' },
  { id: 'sh2', name: 'Glass Water Pipe', price: '$45', icon: '/docs/shop-bong.jpg' },
  { id: 'sh3', name: 'Glass Storage Jar', price: '$16', icon: '/docs/shop-jar.jpg' },
...
const methodGuide = [
  { name: 'Smoking (Joint / Blunt / Pipe / Bong)', icon: '🚬', onset: '1–5 min', duration: '1–3 hrs',
  ...
  { name: 'Kief, Hash & Moon Rocks', icon: '✨', onset: '1–5 min (smoked/vaped)', duration: '1–3 hrs',
